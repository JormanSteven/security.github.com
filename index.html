...
<div class="login">
    ...
    <h1>SP-APPS</h1>
	 <form method="post"   autocomplete="off" id="formlogin" onsubmit="return loginboton();">
    ...
    <div class="form-group">
     ...
     <button type="submit" class="btn btn-primary btn-block btn-large" id="loginboton" >LOGIN</button>
     </br>
